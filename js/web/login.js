	...
	$.ajax({
		...
		success: function (data) {
			if (data == '0') {
				...
				$("#user_div").html('您好！' + username + ' 【<a href="http://cz.xsbmxt.cn/js/web/webOutlogin?orgId=103" style="padding: 4px 16px;background: #FF8A00;border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px;">退出</a>】　　');
